    ...
    public class PlayerReputation : MonoBehaviour
    {
        ...
        public void IncreaseReputation(int value)
        {
            ...
            notificationManager.ShowNotification(
                String.Format(
                    LocalizationSettings.StringDatabase.GetLocalizedString("Glossary", "You won reputation: +{0} points! Current reputation: {1}"),
                    value,
        ...
        public void DecreaseReputation(int value)
        {
            ...
            notificationManager.ShowNotification(
                String.Format(
                    LocalizationSettings.StringDatabase.GetLocalizedString("Glossary", "You lost reputation: -{0} points! Current reputation: {1}"),
                    value,
                    playerStatsDatabase.GetCurrentReputation()
                ),
