...
namespace AF
{
    ...
    public class LockOnManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            cinemachineVirtualCamera = lockOnCamera.GetComponent<CinemachineCamera>();
            cinemachineFramingTransposer = cinemachineVirtualCamera.GetComponent<CinemachinePositionComposer>();

            defaultTrackedOffsetY = cinemachineFramingTransposer.TargetOffset.y;
        ...
        {
            cinemachineVirtualCamera.Target.LookAtTarget = lockOnTarget;
        ...
        void UpdateLockOnYPosition(Transform lockOnTarget)
        {
            ...
            cinemachineFramingTransposer.TargetOffset.y = Mathf.Clamp(
                value,
