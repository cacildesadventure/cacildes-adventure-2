...
namespace AF
{
    ...
    public class EquipmentDatabase : ScriptableObject
    {
        ...
        public Weapon[] secondaryWeapons = new Weapon[3]; // Fixed size array for weapons
        ...
        public Weapon GetCurrentSecondaryWeapon() => secondaryWeapons[currentShieldIndex];
        public Shield GetCurrentShield() => shields[currentShieldIndex];
        public Spell GetCurrentSpell() => spells[currentSpellIndex];

        public Arrow GetCurrentArrow() => arrows[currentArrowIndex];

        public Consumable GetCurrentConsumable() => consumables[currentConsumableIndex];
        ...
        public bool IsPlayerNaked() => helmet == null && armor == null && legwear == null && gauntlet == null;
        public bool IsDualWielding() => GetCurrentWeapon() != null && GetCurrentSecondaryWeapon() != null;
        public int GetEquippedWeaponSlot(Weapon weapon) => Array.IndexOf(weapons, weapon);
        public int GetEquippedShieldSlot(Shield shield) => Array.IndexOf(shields, shield);
        public int GetEquippedArrowsSlot(Arrow arrow) => Array.IndexOf(arrows, arrow);
        public int GetEquippedSpellSlot(Spell spell) => Array.IndexOf(spells, spell);
        public int GetEquippedAccessoriesSlot(Accessory accessory) => Array.IndexOf(accessories, accessory);
        public int GetEquippedConsumablesSlot(Consumable consumable) => Array.IndexOf(consumables, consumable);
