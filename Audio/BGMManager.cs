...
namespace AF.Music
{
    public class BGMManager : MonoBehaviour
    {
        ...
        void HandleVolume()
        {
            bgmAudioSource.volume = gameSettings.musicVolume;
            ambienceAudioSource.volume = gameSettings.musicVolume;
        }
        ...
        {
            float targetVolume = fadeOut ? 0f : gameSettings.musicVolume;
