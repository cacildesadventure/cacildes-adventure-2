...
namespace AF
{
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            defaultFieldOfView = virtualCamera.Lens.FieldOfView;
        ...
        private void Move()
        {
            ...
            if (isSprinting)
            {
                virtualCamera.Lens.FieldOfView = Mathf.Lerp(virtualCamera.Lens.FieldOfView, defaultFieldOfView + sprintFieldOfViewSpeedBonus, sprintFieldOfViewSpeedTransition * Time.deltaTime);
            }
            else
            {
                virtualCamera.Lens.FieldOfView = Mathf.Lerp(virtualCamera.Lens.FieldOfView, defaultFieldOfView, sprintFieldOfViewSpeedTransition * Time.deltaTime);
            }
