...
namespace AF
{
    ...
    public class UIManager : MonoBehaviour
    {
        ...
        {
            notificationManager.ShowNotification(LocalizationSettings.StringDatabase.GetLocalizedString("Glossary", "Can not perform action at this time"), notificationManager.systemError);
        }
