            ...
            if (showNotification)
            {
                ...
                if (requireBadReputation)
                {
                    GetNotificationManager().ShowNotification(
                        LocalizationSettings.StringDatabase.GetLocalizedString("Glossary", "Your good reputation prevents you from entering this house."),
                         GetNotificationManager().personBusy);
                }
                else
                {
                    GetNotificationManager().ShowNotification(
                        LocalizationSettings.StringDatabase.GetLocalizedString("Glossary", "Your bad reputation prevents you from entering this house."),
                        GetNotificationManager().personBusy);
